<script lang="ts">
	...
	const recentPostsCount =
		browser && window.matchMedia('(max-width: 500px)').matches ? 5 : 10;
...
<Layout pageTitle="Home">
	...
	<section>
		<Stack>
			<p>
				My name is <strong>Christopher Einarsson</strong>. I am a
				<strong>Frontend Developer</strong>
				from <strong>Sweden</strong>, generally interested in creating great
				user experiences on the web.
			</p>
			<p>
				Have a look around, read about a subject I have covered and get inspired
				to create great user experiences you too!
			</p>
		</Stack>
	</section>
